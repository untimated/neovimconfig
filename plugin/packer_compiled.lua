...
_G.packer_plugins = {
  ...
  ["ccls.nvim"] = {
    loaded = true,
    path = "/home/michael/.local/share/nvim/site/pack/packer/start/ccls.nvim",
  ...
  ["vim-tomorrow-night-deepblue"] = {
    loaded = true,
    path = "/home/michael/.local/share/nvim/site/pack/packer/start/vim-tomorrow-night-deepblue",
